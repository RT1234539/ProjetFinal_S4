...
<title>Ajouter un Opérateur - Admin Mobile Money</title>
...
<p class="font-body-sm text-body-sm text-secondary">Ajoutez un opérateur externe avec son préfixe</p>
</div>
</div>
</div>
<form action="<?= base_url('autre-operateur/save') ?>" method="post" class="p-lg space-y-lg">
<?= csrf_field() ?>
<!-- Préfixe -->
<div>

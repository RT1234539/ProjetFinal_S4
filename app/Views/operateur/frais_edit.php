...
<ul class="space-y-1">
<li class="mx-2 my-1">
    <a class="flex items-center gap-sm px-md py-sm text-secondary hover:bg-surface-container rounded-lg" href="<?= base_url('prefix') ?>">
        <span class="material-symbols-outlined">phone_iphone</span>
        <span>Préfixes</span>
    </a>
</li>
<li class="mx-2 my-1">
    <a class="flex items-center gap-sm px-md py-sm bg-primary-container text-on-primary-container rounded-lg" href="<?= base_url('frais/ajouter') ?>">
        <span class="material-symbols-outlined" style="font-variation-settings: 'FILL' 1;">payments</span>
        <span>Barèmes</span>
    </a>
</li>
<li class="mx-2 my-1">
    <a class="flex items-center gap-sm px-md py-sm text-secondary hover:bg-surface-container rounded-lg" href="<?= base_url('clients') ?>">
        <span class="material-symbols-outlined">group</span>
        <span>Comptes clients</span>
    </a>
</li>
<li class="mx-2 my-1">
    <a class="flex items-center gap-sm px-md py-sm text-secondary hover:bg-surface-container rounded-lg" href="<?= base_url('gains') ?>">

...
<p class="text-body-sm text-on-surface-variant">Transf&eacute;rez &agrave; un autre num&eacute;ro</p>
</div>
</div>
<form method="POST" action="<?= base_url('clients/transfert') ?>">
<?= csrf_field() ?>
<div class="mb-4">
<label class="block text-label-md font-label-md text-on-surface-variant mb-2">Num&eacute;ro du destinataire</label>
